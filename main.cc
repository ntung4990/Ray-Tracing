#include <iostream>
#include <cstdlib>  // Thay thế drand48 bằng rand
#include <cmath>    // Cho M_PI và các phép toán
#include <cfloat>   // Cho FLT_MAX thay vì MAXFLOAT
            ...
            if ((center - vec3(4, 0.2, 0)).length() > 0.9) {
                if (choose_mat < 0.8) {  // diffuse
                    ...
                    list[i++] = new sphere(center, 0.2,
                        new metal(vec3(0.5 * (1 + rand() / (RAND_MAX + 1.0)),
